...
| `WhatwgStreams/Data/Queue.lean`, `WhatwgStreams/Data/Strategy.lean` | **unclaimed: the P3 builder's fence** | the P2 breadth stubs; the builder is a separate seat, dispatched after `P3-R1` is ruled |
