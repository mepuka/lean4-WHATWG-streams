...
| NIST CAVP `SHA224ShortMsg.rsp`, CAVS 11.0, generated 2011-03-15, 65 vectors (`vendor/nist-cavp-sha224/SHA224ShortMsg.rsp`) | 2026-09-02, vendored at S1.6 | read out of the **git object**, the same way the SHA-256 file was at S1.0: `git -C <clone> ls-tree -r 54e6068abd4658fd91203cae1c2316188ffa0e89 -- validation/vectors/nist/SHA224ShortMsg.rsp` gives blob `ab3b099c73048c279c97f88c3a549e7545c3887b`, then `cmd /c "git -C <clone> cat-file blob ab3b099c… > vendor/nist-cavp-sha224/SHA224ShortMsg.rsp"` (`cmd` redirection is binary-safe; PowerShell's is not). The clone is `kim-em/lean-crypto-hash` at `54e6068abd4658fd91203cae1c2316188ffa0e89` under foldlab `.reference/clones/` | `git hash-object --no-filters` on the vendored file returns `ab3b099c73048c279c97f88c3a549e7545c3887b`, equal to the upstream `ls-tree` object hash, which no host setting or `text` attribute can affect; SHA-256 `4cf7c594ec3a540880756e5cf5095a8b5c9194a8a7868d686efb47187c2e0330`, 9,511 bytes, agreed by `lake exe sha256` (the proved library) and PowerShell `Get-FileHash -Algorithm SHA256` |
