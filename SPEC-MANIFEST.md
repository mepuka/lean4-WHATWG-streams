...
| Lean | `leanprover/lean4:v4.33.1`; `lean-toolchain` SHA-256 `3aac669c7a910ec2389f4e4f921b605adf6ebf2d1e0c9b9cd0be4d33f3f5db71`; one dependency, `hash` (lean4-hash) at commit `0168306b7068b97758e3f2d4307eeb97aa31a104` | kernel, elaborator, compiler, standard library |
...
| FIPS 180-4 | NIST, August 2015; PDF SHA-256 `0455b406d89648d20cbde375561e19c245b9815e894164c2670772e3d54deb82` | transcription source for the SHA-256 specification, owned by lean4-hash since the swap; pin retained here until slice W3b of `docs/WHATWG-PACKAGE-PLAN.md`; formerly the S1 SHA-256 specification |
